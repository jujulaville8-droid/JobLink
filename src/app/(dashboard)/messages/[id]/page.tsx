      ...
      <div className="flex flex-col h-full mx-0 sm:mx-3 my-0 sm:my-2 border-0 sm:border border-border sm:rounded-lg bg-white overflow-hidden">
        ...
        {isEmployer && meta?.application_id && (
          <div className="shrink-0 flex items-center gap-2 px-5 py-2 border-b border-border bg-bg-alt/50">
            ...
            {([
              { key: "interview", label: "Interview", style: "border-emerald-200 bg-emerald-50/50 text-emerald-700 hover:bg-emerald-100 hover:border-emerald-300" },
              { key: "hold", label: "Hold", style: "border-amber-200 bg-amber-50/50 text-amber-700 hover:bg-amber-100 hover:border-amber-300" },
              { key: "rejected", label: "Reject", style: "border-red-200 bg-red-50/50 text-red-600 hover:bg-red-100 hover:border-red-300" },
        ...
        {!isBlocked && isSeekerRejected && (
          <div className="px-5 py-3 bg-red-50 border-t border-red-200 text-center">
            <div className="flex items-center justify-center gap-2">
              ...
              <p className="text-sm text-red-600">Your application was not selected. You can no longer send messages in this conversation.</p>
            </div>
          </div>
        )}
