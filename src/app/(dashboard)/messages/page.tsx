...
export default function MessagesPage() {
  ...
  if (authLoading || loading) {
    return (
      <div>
        <h1 className="text-2xl font-bold font-display text-text sm:text-3xl">Messages</h1>
        <p className="mt-1 text-sm text-text-light">Your conversations with employers and candidates.</p>
      ...
      {conversations.length === 0 ? (
        <div className="mt-16 text-center">
          ...
          <p className="mt-1 text-sm text-text-light max-w-sm mx-auto">
            When you apply to jobs or receive applicants, you can message each other here.
          </p>
        </div>
      ) : (
            ...
            >
              ...
              <div className="min-w-0 flex-1">
                ...
                <p className="text-xs text-text-muted mt-0.5 truncate">
                  Re: {conv.application_context.job_title} at {conv.application_context.company_name}
                </p>
