    ...
    <div>
      ...
      {apps.length > 0 ? (
        ...
        <div className="mt-12 flex flex-col items-center justify-center rounded-[--radius-card] border-2 border-dashed border-border p-12 text-center">
          ...
          <Link
            href="/jobs"
            className="mt-6 inline-flex items-center rounded-[10px] bg-primary-light px-5 py-2.5 text-sm font-semibold text-white hover:bg-primary transition-all duration-200 hover:-translate-y-px hover:shadow-md hover:shadow-primary/20"
          >
            Browse Jobs
          </Link>
        </div>
