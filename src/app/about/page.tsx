...
export default function AboutPage() {
  return (
    <div className="min-h-screen bg-white">
      {/* Hero */}
      <section className="bg-gradient-to-br from-primary-dark to-primary text-white py-16 md:py-24">
      ...
      <section className="py-16 px-4 bg-[#faf9f7]">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-2xl md:text-3xl font-bold font-display text-primary mb-10 text-center">
            How It Works
          </h2>
            ...
            <div>
              ...
              <ol className="space-y-4 text-[#71717a]">
                <li className="flex gap-3">
                  <span className="flex-shrink-0 w-8 h-8 bg-primary-light text-white rounded-full flex items-center justify-center font-bold text-sm">
                    1
                  </span>
      ...
      <section className="py-16 px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <a
            ...
            className="inline-block bg-primary-light hover:bg-primary text-white font-semibold px-8 py-3 rounded-full transition-colors"
          >
            Contact Us
          </a>
      ...
      <section className="bg-primary text-white py-16 px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              href="/signup"
              className="bg-primary-light hover:bg-primary text-white font-semibold px-8 py-3 rounded-full transition-colors text-center"
            >
              Find a Job
            </Link>
            <Link
              href="/signup"
              className="border border-white/30 text-white hover:bg-white hover:text-primary font-semibold px-8 py-3 rounded-full transition-colors text-center"
            >
              Post a Job
            </Link>
          </div>
