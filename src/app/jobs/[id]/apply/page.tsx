      ...
      <div className="mx-auto max-w-2xl px-4 py-16">
        ...
        >
          ...
          >
            ...
            <Link
              href="/jobs"
              className="mt-6 inline-flex items-center gap-2 rounded-xl bg-primary px-5 py-2.5 text-sm font-semibold text-white hover:bg-primary-dark transition-all duration-200 hover:-translate-y-px hover:shadow-md hover:shadow-primary/20"
            >
          ...
          <motion.div variants={item} className={cardBase}>
            ...
            <div className="p-8 text-center">
              ...
              <div className="mt-6 flex flex-col sm:flex-row items-center justify-center gap-3">
                ...
                <Link
                  href="/jobs"
                  className="inline-flex items-center gap-2 rounded-xl border-2 border-border bg-white px-5 py-2.5 text-sm font-medium text-text-light hover:text-primary hover:border-primary/30 transition-all duration-200"
                >
                  <HugeiconsIcon icon={Search01Icon} size={14} />
                  Continue Browsing
                </Link>
  ...
  return (
    <div className="mx-auto max-w-2xl px-4 py-8">
      ...
      >
        <Link
          href={`/jobs/${jobId}`}
          className="inline-flex items-center gap-1.5 text-sm font-medium text-text-muted hover:text-primary transition-colors mb-5"
        >
        ...
        >
          <div className="p-5 flex items-center gap-4">
            ...
            <div className="flex-1 min-w-0">
              ...
              <h1 className="text-lg font-bold text-text truncate mt-0.5">
                {job?.title}
              </h1>
          ...
          <form onSubmit={handleSubmit} className="p-5 space-y-5">
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full rounded-xl border border-border/60 bg-white px-4 py-3 text-sm text-text placeholder:text-text-muted/60 focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all duration-200 resize-y"
              />
              <div className="mt-1.5 flex items-center justify-between">
                <p className="text-xs text-text-muted">
                  Your profile and CV will be shared automatically.
                </p>
                <p className="text-xs text-text-muted tabular-nums">
                  {coverLetter.length}/2,000
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3 rounded-xl bg-bg-alt/60 border border-border/30 p-4">
              ...
              <p className="text-xs text-text-muted leading-relaxed">
                ...
                profile information (name, contact details, and CV) with the
                employer for this position. Your data will only be used for
