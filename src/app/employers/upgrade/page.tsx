...
export default function UpgradePage() {
  ...
  return (
    <div className="min-h-screen" style={{ background: 'linear-gradient(180deg, #ffffff 0%, #e8f5f5 100%)' }}>

      {/* ─── Hero ─── */}
      <section className="relative overflow-hidden" style={{ background: 'linear-gradient(135deg, #095355 0%, #0d7377 50%, #14919b 100%)' }}>
      ...
      <section className="mx-auto max-w-md px-4 py-16">
        <div className="rounded-2xl border border-primary/20 p-8 shadow-lg sm:p-10" style={{ background: 'linear-gradient(160deg, #f0fafa 0%, #e0f4f4 50%, #d5efef 100%)' }}>
          {/* Badge */}
