-- ============================================
-- JobLink Database Schema (Fresh Install)
-- Drop existing types first to avoid conflicts
-- ============================================
...
DROP TYPE IF EXISTS visibility_mode CASCADE;
DROP TYPE IF EXISTS job_type CASCADE;
DROP TYPE IF EXISTS job_status CASCADE;
DROP TYPE IF EXISTS application_status CASCADE;

-- Drop existing tables if they exist
DROP TABLE IF EXISTS public.reported_listings CASCADE;
